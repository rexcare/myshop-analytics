...
'''
eg https://sellercentral.amazon.com/apps/authorize/consent?application_id=amzn1.sellerapps.app.0bf296b5-36a6-4942-a13e-EXAMPLEfcd28
'''
...
def oauth():
    ...
    auth_url = f"https://sellercentral.amazon.com/apps/authorize/consent?application_id={app_id}&state={state}&version=beta"
    print(auth_url)
...
def get_orders(access_token):
    api_endpoint = 'https://sellingpartnerapi-na.amazon.com/orders/v0/orders?MarketplaceIds=A14B4EAZ7UZPBA&CreatedAfter="2023-03-01T00:00:00.000Z'
